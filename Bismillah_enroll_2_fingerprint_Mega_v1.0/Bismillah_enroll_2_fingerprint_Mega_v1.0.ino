...
void loop()                     // run over and over again
{
  ...
  deleteFingerprint(id, &finger1);
  getFingerprintEnroll(&finger1);

  Serial.println("Now please put your same finger on second fingerprint scanner");
  delay(2000);
  deleteFingerprint(id, &finger2);
  getFingerprintEnroll(&finger2);
